...
java -classpath "$SPECIFY_CLASSPATH:$CLASSPATH" -Dconfig -Dappdir=$SPECIFY_HOME/Specify -Dappdatadir=$SPECIFY_HOME -Djavadbdir=$SPECIFY_HOME/DerbyDatabases edu.ku.brc.specify.Specify "$@"
