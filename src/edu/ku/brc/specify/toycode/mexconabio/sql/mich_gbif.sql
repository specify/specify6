...
--
-- Table structure for table `gbifsnib`
--

DROP TABLE IF EXISTS `gbifsnib`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `gbifsnib` (
  `GBIFSNIBID` int(11) NOT NULL AUTO_INCREMENT,
  `reltype` tinyint(4) DEFAULT NULL,
  `score` tinyint(4) DEFAULT NULL,
  `GBIFID` int(11) NOT NULL,
  `SNIBID` int(11) NOT NULL,
  PRIMARY KEY (`GBIFSNIBID`),
  KEY `GBIFINX` (`GBIFID`),
  KEY `SNIBINX` (`SNIBID`)
