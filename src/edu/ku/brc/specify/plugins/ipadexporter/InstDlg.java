 ...
 *
 */
public class InstDlg extends CustomDialog
{
     ...
     */
    public InstDlg(final IPadCloudIFace cloudHelper) throws HeadlessException
    {
        super((Frame)getTopWindow(), "INST_INFO", true, OKCANCEL, null);
     ...
     * @return
     */
//    private boolean doesGUIDExists(final String uri)
//    {
//        try
//        {
