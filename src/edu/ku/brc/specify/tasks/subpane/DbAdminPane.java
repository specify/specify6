    ...
    public void createUI(){
        ...
        PanelBuilder mainFormBuilder = new PanelBuilder(
                new FormLayout(
                        ...
                        "p,3dlu, p,3dlu, p,3dlu, p,3dlu, p,3dlu, p,3dlu, p,3dlu, p,3dlu, p,3dlu, p,3dlu, p,3dlu, p,3dlu, p,3dlu"),p);//rows
        ...
        ListSlider userGroups = new ListSlider(listOfAvailableUserGroups,  "Available Groups",  listOfSelectedUserGroups,
        "Selected Groups");
