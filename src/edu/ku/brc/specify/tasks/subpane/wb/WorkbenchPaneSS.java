...
//                    NavBoxMgr.getInstance().closeSplitter();
    ...
    protected Pair<WorkbenchTemplateMappingItem, List<WorkbenchTemplateMappingItem>> selectColumnName()
    {
        ...
        CustomDialog dlg = JOptionPane.showMessageDialog((Frame)null, getResourceString("GE_CHOOSE_FIELD_FOR_EXPORT_TITLE"), true, pb.getPanel(){
...
//        	}
    ...
    {        
        ...
        if (logins.size() > 0)
        {
            ...
            CustomDialog dlg2 = JOptionPane.showMessageDialog(null,
