 ...
 *
 */
public class ColumnMapperDlg3 extends CustomDialog
{
     ...
     */
    public ColumnMapperDlg3(final Frame frame, final String title, final ImportDataFileInfo dataFileInfo)
    {
     ...
     * @param dataFileInfo the information about the data file.
     */
    public ColumnMapperDlg3(final Frame frame, final String title, final WorkbenchTemplate wbTemplate)
    {
        super(frame, title, true, OKCANCELAPPLYHELP, null);
    ...
    public void createUI()
    {
        ...
        for (FieldMappingPanel panel : mappingItems)
        {
            mapModel.add(panel);  
        }
        ...
        JScrollPane sp = new JScrollPane(mapList, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
    ...
    class FieldMappingPanel extends JPanel
    {
        ...
        public FieldMappingPanel(final ImportColumnInfo colInfo, final ImageIcon mappingIcon)
        {
            ...
            addMouseListener(ma);
            fieldLabel.addMouseListener(ma);
            mappingLabel.addMouseListener(ma);
