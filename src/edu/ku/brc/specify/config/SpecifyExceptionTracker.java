...
public class SpecifyExceptionTracker extends ExceptionTracker
{
    ...
    /* (non-Javadoc)
     * @see edu.ku.brc.exceptions.ExceptionTracker#getExceptionItem(java.lang.Class, java.lang.Exception)
     */
    @Override
    protected ExceptionItem getExceptionItem(final Class<?> cls, final Exception exception)
    {
        ...
        CustomDialog dlg = new CustomDialog((Frame)null, "Handled Exception", true, pb.getPanel())
        {
            ...
            protected void cancelButtonPressed()
            {
                ...
                ExceptionItem item = new ExceptionItem(taskName, titleTF.getText(), bugTF.getText(), commentsTA.getText(), stackTraceTA.getText(), cls.getName());
