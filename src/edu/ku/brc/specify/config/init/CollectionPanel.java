 ...
 *
 */
public class CollectionPanel extends GenericFormPanel
{
     ...
     * @param makeStretchy
     */
    public CollectionPanel(String name, String title, String helpContext, String[] labels,
    ...
    public boolean isUIValid()
    {
        ...
        if (tf != null)
        {
            ...
            {
                int cnt = BasicSQLUtils.getCountAsInt(String.format("SELECT COUNT(*) FROM collection WHERE CollectionName = '%s'", name));
                if (cnt > 0)
                {
