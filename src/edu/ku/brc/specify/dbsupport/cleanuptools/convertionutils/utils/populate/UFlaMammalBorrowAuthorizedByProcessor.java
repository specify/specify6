 ...
 *
 */
public class UFlaMammalBorrowAuthorizedByProcessor extends
		UFlaTransactionAgentProcessor {

	public UFlaMammalBorrowAuthorizedByProcessor(Connection connection, List<Pair<String, Object>> newAgentDefaults,
