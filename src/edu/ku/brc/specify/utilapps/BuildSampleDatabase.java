        ...
        if (driverInfo.getName().equals("MySQL"))
        {
            ...
            try
            {
                ...
                if (stmt != null)
                {
                    ...
                    String createUserStr = "GRANT SELECT,INSERT,UPDATE,DELETE,CREATE TEMPORARY ON "+databaseName+".* TO '"+saUserName+"'@'%' IDENTIFIED BY '"+saPassword+"'";
                    int rv = stmt.executeUpdate(createUserStr);
                    createUserStr = "GRANT SELECT,INSERT,UPDATE,DELETE,CREATE TEMPORARY ON "+databaseName+".* TO '"+saUserName+"'@'localhost' IDENTIFIED BY '"+saPassword+"'";
