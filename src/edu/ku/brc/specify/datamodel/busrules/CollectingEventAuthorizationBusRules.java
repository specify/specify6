...
import edu.ku.brc.specify.datamodel.CollectingEventAuthorization;
 ...
 *
 */
public class CollectingEventAuthorizationBusRules extends BaseBusRules
{
     ...
     *
     */
    public CollectingEventAuthorizationBusRules()
    {
        super(CollectingEventAuthorizationBusRules.class);
    }
    ...
    {
        CollectingEventAuthorization ceAuth = (CollectingEventAuthorization) dataObj;
        Permit                 permit  = ceAuth.getPermit();
        if (permit != null && session != null)
        {
            session.attach(permit);
            removeById(permit.getCollectingEventAuthorizations(), ceAuth);
            ceAuth.setPermit(null);
        }
        if (ceAuth.getCollectingEvent() != null)
        {
            removeById(ceAuth.getCollectingEvent().getCollectingEventAuthorizations(), ceAuth);
            ceAuth.setCollectingEvent(null);
        }
        return dataObj;
    }
