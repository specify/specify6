...
public class SpecifyUserBusRules extends BaseBusRules
{
                           ...
                           final BusinessRulesOkDeleteIFace deletable)
    {
        ...
        if (deletable != null)
        {
            SpecifyUser su = (SpecifyUser)dataObj;
            ...
            {
                isOK = okToDelete(0, new String[] {"spquery", "SpecifyUserID", "spreport", "SpecifyUserID", "workbench", "SpecifyUserID", "workbenchtemplate", "SpecifyUserID"}, 
                		su.getId());
            }
