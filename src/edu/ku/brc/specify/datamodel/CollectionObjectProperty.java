...
@Table(name = "collectionobjectproperty")
@org.hibernate.annotations.Table(appliesTo="collectionobjectproperty", indexes =
        {
                @Index (name="COLOBJPROPColMemIDX", columnNames={"CollectionMemberID"})
        })
public class CollectionObjectProperty extends CollectionMember implements Cloneable
{
    protected static final Logger log = Logger.getLogger(CollectionObjectProperty.class);
    ...
    /** default constructor */
    public CollectionObjectProperty()
    {
        // do nothing
    }

    /** constructor with id */
    public CollectionObjectProperty(Integer collectionObjectPropertyId)
    {
        this.collectionObjectPropertyId = collectionObjectPropertyId;
    }
    ...
    @Id
    @GeneratedValue
    @Column(name = "CollectionObjectPropertyID", unique = false, nullable = false, insertable = true, updatable = true)
    public Integer getCollectionObjectPropertyId()
    {
        return collectionObjectPropertyId;
    }
    ...
    public void setCollectionObjectPropertyId(Integer collectionObjectPropertyId)
    {
        this.collectionObjectPropertyId = collectionObjectPropertyId;
    }

    /* more generic matching stuff compared to localitydetail match method for example.
        Not currently used, could be implement in Datamodelobjbase to replace localitydetail and other class's match methods.
    */

    private String[] unMatchables = {"id", "collectionobjectpropertyid", "version", "createbyagentid", "modifiedbyagentid",
    ...
    private boolean matches(CollectionObjectProperty o, Method m) {
        if (matchThisField(m)) {
            try {
     ...
     *
     */
    public boolean matches(CollectionObjectProperty o) {
        if (o == null) {
            return false;
        }
    ...
    {
        CollectionObjectProperty obj    = (CollectionObjectProperty)super.clone();
        obj.collectionObjectPropertyId  = null;
    ...
    {
        return CollectionObjectProperty.class;
    }
