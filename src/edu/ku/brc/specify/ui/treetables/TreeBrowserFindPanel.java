...
public class TreeBrowserFindPanel extends JPanel implements TimingTarget
{
     ...
     * @param startingMode
     */
    public TreeBrowserFindPanel(final TreeBrowserPanel treeBrowserPanel, final int startingMode)
    {
    ...
    {
        treeBrowserPanel.find(entryField.getText(), true, exactChk.isSelected());
    }
    ...
    {
       nextButton.setEnabled(treeBrowserPanel.doFindNext());
    }
