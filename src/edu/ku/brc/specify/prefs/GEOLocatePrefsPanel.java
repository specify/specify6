...
public class GEOLocatePrefsPanel extends GenericPrefsPanel
{
    ...
    /* remove if worldwind is broken*/protected ValCheckBox  geoLocMapServerCBX;
    ...
    public void createForm(final String viewSetName, final String viewName)
    {
        ...
        /* remove if worldwind is broken*/geoLocMapServerCBX = form.getCompById(GL_USEGL_MAPS);
        ...
        /* remove if worldwind is broken*/geoLocMapServerCBX.setValue(locPrefs.getBoolean(GL_USEGL_MAPS, true), null);
  ...
  //--------------------------------------------------------------------
    ...
    public void savePrefs()
    {
        ...
        /* remove if worldwind is broken*/saveCBX(geoLocMapServerCBX, GL_USEGL_MAPS);
