 ...
 */
public class NavBoxLayoutManager2 implements LayoutManager2, Serializable 
{
    private int axis;
     ...
     */
    public NavBoxLayoutManager2(Container target, int axis) {
     ...
     * asynchronously.
     *
     * @param targetArg  the affected container
     *
     * @exception AWTError  if the target isn't the container specified to the
     *                      BoxLayout constructor
     */
    public synchronized void invalidateLayout(Container targetArg) 
    {
        checkContainer(targetArg);
        xChildren = null;
        yChildren = null;
        xTotal = null;
        yTotal = null;
     ...
     *
     * @param targetArg  the container that needs to be laid out
     ...
     */
    public synchronized Dimension preferredLayoutSize(Container targetArg) 
    {
        Dimension size;
        synchronized(this) 
        {
        ...
        Insets insets = targetArg.getInsets();
     ...
     * @see #maximumLayoutSize
     */
    public synchronized Dimension minimumLayoutSize(Container targetArg) 
    {
        Dimension size;
        synchronized(this) {
            checkContainer(targetArg);
     ...
     * @see #minimumLayoutSize
     */
    public synchronized Dimension maximumLayoutSize(Container targetArg) 
    {
        Dimension size;
        synchronized(this) {
            checkContainer(targetArg);
     ...
     *                      BoxLayout constructor
     */
    public synchronized float getLayoutAlignmentX(Container targetArg) 
    {
        checkContainer(targetArg);
        checkRequests();
     ...
     *                      BoxLayout constructor
     */
    public synchronized float getLayoutAlignmentY(Container targetArg) 
    {
        checkContainer(targetArg);
        checkRequests();
     ...
     *
     * @param targetArg  the container to lay out
     *
     * @exception AWTError  if the target isn't the container specified to the
     *                      BoxLayout constructor
     */
    public synchronized void layoutContainer(Container targetArg) 
    {
        checkContainer(targetArg);
        int nChildren = targetArg.getComponentCount();
        int[] xOffsets = new int[nChildren];
        int[] xSpans = new int[nChildren];
        int[] yOffsets = new int[nChildren];
        int[] ySpans = new int[nChildren];
            
        Dimension alloc = targetArg.getSize();
        Insets in = targetArg.getInsets();
        alloc.width -= in.left + in.right;
        alloc.height -= in.top + in.bottom;

        // Resolve axis to an absolute value (either X_AXIS or Y_AXIS)
        ComponentOrientation o = targetArg.getComponentOrientation();
        ...
        {
            Component c = targetArg.getComponent(i);
    ...
    void checkContainer(Container targetArg) 
    {
        if (this.target != targetArg) {
